...
// according to Douglas Adams ' "The Hitchhiker'
// s Guide to the Galaxy ". For Freud, the answer was quite different.
...
// because for Freud, everything was basically related to, and explained by sex.

// In this kata, the toFreud()
// function will take a string as its argument, and
// return a string with every word replaced by the explanation to everything, according to Freud.Note that an empty string, or no arguments, should result in the ouput being ""(empty string).
